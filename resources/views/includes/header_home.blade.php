        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-6 col-md-2 d-flex justify-content-center">
                    <!-- START nav -->
                    <nav class="navbar navbar-dark ftco_navbar bg-dark ftco-navbar-light">
                        <div class="container">
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-6 col-md-2 d-flex justify-content-center">
                    ...
                    <nav class="navbar navbar-dark ftco_navbar bg-dark ftco-navbar-light">
                        <div class="container">
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav1"
                                    aria-controls="ftco-nav1" aria-expanded="false" aria-label="Toggle navigation" style="color: white;">
                                <span class="fa fa-bars"></span> Menu
                            </button>
