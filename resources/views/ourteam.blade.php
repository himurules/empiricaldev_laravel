...
@section('title', 'Our Team - Empirical Developments')

@section('description', 'Meet the dedicated and skilled team members of Empirical Developments. Our team consists of experienced professionals who specialize in various aspects of home building, renovations, property development, and landscaping. Get to know our team and discover the expertise and passion that drives us to deliver exceptional results.')

@section('keywords', 'Empirical Developments, our team, home building, renovations, property development, landscaping, experienced professionals, exceptional results')
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url({{ asset('storage/images/team-1.jpg') }});">
                                <div class="box">
                                    <h2>Ryan Anderson</h2>
                                    <p>Head Engineer</p>
                                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url({{ asset('storage/images/team-2.jpg') }});">
                                <div class="box">
                                    <h2>Greg Washer</h2>
                                    <p>Head Engineer</p>
                                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url({{ asset('storage/images/team-3.jpg') }});">
                                <div class="box">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url({{ asset('storage/images/team-4.jpg') }});">
                                <div class="box">
                                    <h2>Jack Smith</h2>
                                    <p>Architect</p>
                                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url({{ asset('storage/images/team-5.jpg') }});">
                                <div class="box">
                                    <h2>Ryan Anderson</h2>
                                    <p>President</p>
                                </div>
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="{{ asset('storage/images/team-5.jpg') }}" alt="">
                                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url({{ asset('storage/images/team-6.jpg') }});">
                                <div class="box">
                                    <h2>Greg Washer</h2>
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="{{ asset('storage/images/team-6.jpg') }}" alt="">
                                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url({{ asset('storage/images/team-7.jpg') }});">
                                <div class="box">
                                    <h2>Tony Henderson</h2>
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="{{ asset('storage/images/team-7.jpg') }}" alt="">
                                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url({{ asset('storage/images/team-8.jpg') }});">
                                <div class="box">
                                    <h2>Jack Smith</h2>
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="{{ asset('storage/images/team-8.jpg') }}" alt="">
                                    </div>
