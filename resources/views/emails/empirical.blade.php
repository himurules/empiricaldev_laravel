...
<head>
    ...
    <title>Empirical developments Email</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
            ...
            <tr>
                <td valign="top" class="bg_white" style="padding: 1em 2.5em 0 2.5em;">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="logo text-uppercase" style="text-align: center;">
                                <h1>
                                    <a href="#">{{ $user['username'] }} has reached out to you through the website.</a>
                                </h1>
                            </td>
                        </tr>
                    </table>
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
            <tr>
                <td class="bg_light" style="text-align: center;">
                    <p>Empirical Developments Copyright ©2024 All rights reserved</p>
                </td>
            </tr>
        </table>
