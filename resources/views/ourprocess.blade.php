...
@section('title', 'Our Process - Empirical Developments')

@section('description', 'Learn about the process of working with Empirical Developments for your construction needs in the Sydney Area. From initial consultation to project completion, we follow a structured and efficient process to ensure client satisfaction. Discover our step-by-step approach today.')

@section('keywords', 'Empirical Developments, our process, construction needs, Sydney Area, consultation, project completion, structured process, client satisfaction')
        ...
        <div class="container">
            ...
            <div class="row d-flex">
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch w-100">
                        <a href="#" class="block-20 rounded"
                           style="background-image: url('{{ asset('storage/images/image_1.jpg') }}');">
                        </a>
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch w-100">
                        <a href="#" class="block-20 rounded"
                           style="background-image: url('{{ asset('storage/images/image_2.jpg') }}');">
                        </a>
                        <div class="media-body p-2 mt-3">
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch w-100">
                        <a href="#" class="block-20 rounded"
                           style="background-image: url('{{ asset('storage/images/image_3.jpg') }}');">
                        </a>
                        <div class="media-body p-2 mt-3">
            ...
            <div class="row d-flex">
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch w-100">
                        <a href="#" class="block-20 rounded"
                           style="background-image: url('{{ asset('storage/images/image_4.jpg') }}');">
                        </a>
                        <div class="media-body p-2 mt-3">
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch w-100">
                        <a href="#" class="block-20 rounded"
                           style="background-image: url('{{ asset('storage/images/image_5.jpg') }}');">
                        </a>
                        <div class="media-body p-2 mt-3">
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch w-100">
                        <a href="#" class="block-20 rounded"
                           style="background-image: url('{{ asset('storage/images/image_6.jpg') }}');">
                        </a>
                        <div class="media-body p-2 mt-3">
